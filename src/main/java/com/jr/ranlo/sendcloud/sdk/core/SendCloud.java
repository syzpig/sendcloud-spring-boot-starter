package com.jr.ranlo.sendcloud.sdk.core;


import com.jr.ranlo.sendcloud.autoConfiguration.SendCloudEmailProperties;
import com.jr.ranlo.sendcloud.common.StaticMethodGetBean;
import com.jr.ranlo.sendcloud.sdk.config.Config;
import com.jr.ranlo.sendcloud.sdk.config.Credential;
import com.jr.ranlo.sendcloud.sdk.exception.SmsException;
import com.jr.ranlo.sendcloud.sdk.exception.VoiceException;
import com.jr.ranlo.sendcloud.sdk.model.*;
import com.jr.ranlo.sendcloud.sdk.util.HttpUtil;
import com.jr.ranlo.sendcloud.sdk.util.Md5Util;
...
public class SendCloud {
    ...
    @Autowired
    private SendCloudEmailProperties sendCloudEmailProperties;
...
//        SendCloudEmailProperties sendCloudEmailProperties = StaticMethodGetBean.getBean(SendCloudEmailProperties.class);
        Asserts.notNull(mail, "demo");
        Asserts.notBlank(sendCloudEmailProperties.getApiUser(), "api_user");
        Asserts.notBlank(sendCloudEmailProperties.getApiKey(), "api_key");
        mail.validate();
        Credential credential = new Credential(sendCloudEmailProperties.getApiUser(), sendCloudEmailProperties.getApiKey());
    ...
    private ResponseData post(Credential credential, SendCloudMail mail) throws ClientProtocolException, IOException {
        ...
        HttpPost httpPost = new HttpPost(mail.getContent().useTemplate() ? Config.send_template_api : Config.send_api);
    ...
    public ResponseData sendSms(SendCloudSms sms) throws ClientProtocolException, IOException, SmsException {
        ...
        Asserts.notBlank(sendCloudEmailProperties.getSmsUser(), "sms_user");
        Asserts.notBlank(sendCloudEmailProperties.getSmsKey(), "sms_key");
        sms.validate();
        Credential credential = new Credential(sendCloudEmailProperties.getSmsUser(), sendCloudEmailProperties.getSmsKey());
